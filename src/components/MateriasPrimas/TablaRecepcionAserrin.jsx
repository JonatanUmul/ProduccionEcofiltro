...
const TablaAserrin = () => {
  ...
  const DatosApi = async () => {
    try {
      const response = await axios.get(`${URL}/MateriaPriaBarro`, {
        params: { materiaPrima },
      });
    ...
    >
      ...
      >
        ...
        <div style={{ flexGrow: 1, overflowY: "auto" }}>
          <PaginasAserrin activeTabKey={pagina} materiaPrima={materiaPrima} />
        </div>
      </div>
