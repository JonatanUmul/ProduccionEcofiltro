        ...
        <Row gutter={16}>
          ...
          <Col xs={24} sm={12} md={12}>
            <Form.Item label="Nombre de Producto" required tooltip="This is a required field" rules={[{ required: true, message: 'Por favor ingrese una cantidad!' }]}>
              <Input disabled placeholder="Input Product Name" value='Aserrin Tamizado la Union 1' size="small"  />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={12}>
          ...
          <Form.Item label="MP100018 Aserrin Seco La Union" required tooltip="This is a required field" name="sacosconsumido" rules={[{ required: true, message: 'Por favor ingrese una cantidad!' }]}>
