        ...
        <Row gutter={16}>
          <Col xs={24} sm={12} md={8}>
            <Form.Item label="Código de Producto" required tooltip="This is a required field" rules={[{ required: true, message: 'Por favor ingrese una cantidad!' }]}>
              <Input disabled placeholder="Input Product Code" value='MP100002' size="small"  required/>
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={8}>
            <Form.Item label="Nombre de Producto" required tooltip="This is a required field" rules={[{ required: true, message: 'Por favor ingrese una cantidad!' }]}>
              <Input disabled placeholder="Input Product Name" value='Barro Seco' size="small"  />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={8}>
          ...
          <Form.Item label="Sacos de barro" required tooltip="This is a required field" name="cantidadPlanificada" rules={[{ required: true, message: 'Por favor ingrese una cantidad!' }]}>
              <Input  placeholder="Sacos" size="small" value={sacos} readOnly   />
              <Input placeholder="Barro Planificado" size="small" value={sacos} />
