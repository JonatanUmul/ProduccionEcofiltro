        ...
        <Page key={i} style={styles.page}>
          <View style={[styles.container, { textAlign: 'center' }]}>
            ...
            <View style={[styles.titleContainer, { flex: 4 }]}>
              ...
              <Text style={[styles.title]}>CONTROL IMPREGNACIÓN DIARIO</Text>
            </View>
          ...
          <View style={styles.table}>
            <View style={styles.tableHeader}>
              ...
              <Text style={styles.tableCell}>Impregnado</Text>
              <Text style={styles.tableCell}>Tipo de plata</Text>
           
              <Text style={styles.tableCell}>Firma</Text>
            </View>
            {pageData.map((fila, index) => (
              <View key={index} style={styles.tableRow}>
                <Text style={styles.tableCell}>{formatFecha(fila.fechaCreacion)}</Text>
                ...
                <Text style={styles.tableCell}>{fila.impregnados}</Text>
                <Text style={styles.tableCell}>{fila.TipoPlata}</Text>
