        ...
        pages.push(
          ...
          <View style={[styles.container, { textAlign: 'center' }]}>
            ...
            <View style={[styles.titleContainer, { flex: 4 }]}>
              ...
              <Text style={[styles.title]}>CONTROL LOTES DE Aserrin</Text>
            </View>
          ...
          <View style={styles.table}>
            <View style={styles.tableHeader}>
              ...
              <Text style={styles.tableCell}>Lote Aserrin</Text>
              {/*<Text style={styles.tableCell}>Sacos</Text>*/}
              <Text style={styles.tableCell}>OT Mezclado</Text>
              {/*<Text style={styles.tableCell}>Estado</Text>*/}
              <Text style={styles.tableCell}>Lb. Mezcla</Text>
              <Text style={styles.tableCell}>OT. Formula</Text>
              <Text style={styles.tableCell}>Formulas</Text>
              <Text style={styles.tableCell}>Lb. Formula</Text>
              <Text style={styles.tableCell}>Humedad</Text>
              <Text style={styles.tableCell}>Tiempo Mezclado</Text>
              <Text style={styles.tableCell}>Producido</Text>
              <Text style={styles.tableCell}>Modelo</Text>
            </View>
            {pageData.map((fila, index) => (
              <View key={index} style={styles.tableRow}>
                <Text style={styles.tableCell}>{formatFecha(fila.fecha)}</Text>
                <Text style={styles.tableCell}>{fila.codigo_lote}</Text>
               {/* <Text style={styles.tableCell}>{fila.sacos}</Text>*/}
                <Text style={styles.tableCell}>{fila.om_correlativo}</Text>
                {/*<Text style={styles.tableCell}>{fila.aprobado}</Text>*/}
                <Text style={styles.tableCell}>{fila.libras_aserrin}</Text>
                <Text style={styles.tableCell}>{fila.afm_correlativo}</Text>
                <Text style={styles.tableCell}>{fila.dfm_cantidad}</Text>
                <Text style={styles.tableCell}>{fila.dfm_peso}</Text>
                <Text style={styles.tableCell}>{fila.dfm_humedad}%</Text>
                <Text style={styles.tableCell}>{fila.tiempo_mezclado}</Text>
                <Text style={styles.tableCell}>{fila.producido}</Text>
                <Text style={styles.tableCell}>{fila.nombre_modelo}</Text>
