        ...
        pages.push(
          ...
          <View style={[styles.container, { textAlign: 'center' }]}>
            ...
            <View style={[styles.titleContainer, { flex: 4 }]}>
              ...
              <Text style={[styles.title]}>CONTROL LOTES DE BARRO</Text>
            </View>
          ...
          <View style={styles.table}>
            <View style={styles.tableHeader}>
              ...
              <Text style={styles.tableCell}>Libras de barro</Text>
              <Text style={styles.tableCell}>Uf producidas</Text>
              <Text style={styles.tableCell}>L. Liquido</Text>
              <Text style={styles.tableCell}>L. plastico</Text>
              <Text style={styles.tableCell}>I. Plastico</Text>
              <Text style={styles.tableCell}>Arcilla</Text>
              <Text style={styles.tableCell}>Arena</Text>
              <Text style={styles.tableCell}>Limo</Text>
            </View>
            {pageData.map((fila, index) => (
              <View key={index} style={styles.tableRow}>
                ...
                <Text style={styles.tableCell}>{fila.peso_total_libras}</Text>
                <Text style={styles.tableCell}>{fila.producido}</Text>
                <Text style={styles.tableCell}>{fila.limite_liquido}</Text>
                <Text style={styles.tableCell}>{fila.limite_plastico}</Text>
                <Text style={styles.tableCell}>{fila.indice_plastico}</Text>
                <Text style={styles.tableCell}>{fila.arcilla}</Text>
                <Text style={styles.tableCell}>{fila.arena}</Text>
                <Text style={styles.tableCell}>{fila.limo}</Text>
