...
const Update_SerieEcofiltroCrudos = async ({ estadosPorSeriePunto }) => {
  console.log('estadosPorSeriePuntodasaa',estadosPorSeriePunto)
  const URL = process.env.REACT_APP_URL;

  try {
    const response = await axios.put(`${URL}/Update_SerieEcofiltroTasaPunto`, {
